...
> 🚀 **New · 2026-05-27** — **OpenClaw v2026.5.26**: Cached gateway startup (no more repeated plugin/session scans), SSRF + prompt-injection security hardening, emoji reaction approvals on WhatsApp/Signal/iMessage, inspectable Realtime Talk, Activity tab + OpenTelemetry LLM spans, and transcript-backed meeting store. [See full changelog →](./CHANGELOG.md)
