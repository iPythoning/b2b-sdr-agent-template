...
> 🚀 **New · 2026-06-09** — **OpenClaw v2026.6.5**: Parallel web-search integration for richer prospect research, ClawHub skill installation with pinned commits for safer deployments, Anthropic extended-thinking session recovery, Google Chat native approval cards, WhatsApp config-reload teardown fix, SQLite-backed auth profiles, and QQBot reasoning-tag filtering for cleaner channel replies. [See full changelog →](./CHANGELOG.md)
